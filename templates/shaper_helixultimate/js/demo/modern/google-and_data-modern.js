...
const data = {
  ...
  "texts": {
    "welcome": "Мы приглашаем вас вместе с нами открыть новую главу нашей истории.<br/><br/>Ждем вас на свадебном торжестве, посвященном нашему бракосочетанию.",
 //   "dresscode": "Дресс-код: элегантный стиль. Пожалуйста, приходите в красивой одежде, которая соответствует торжественному настроению.",
    "details": [
      "Пожалуйста, обратите внимание на время прихода и заранее сообщите нам, если у вас возникнут вопросы.",
      "Гости издалека смогут остаться в усадьбе на ночь, мы организуем транспорт с Бреста до усадьбы и обратно",
      ""
    ],
    "registrationTitle": "Торжественная регистрация",
  //  "banquetTitle": "Праздничный банкет",
    "WhereTitle": "Ждём вас:",
    "dresscodeColors": {
      "color1": "#e7d4d4",
      "color2": "#d55eb5",
    ...
    "pinterestLink": "https://wow-card.ru/brif-dlya-sajta"
  },
  "rsvpDate": "02 июня 2024",
  "time": {
    "guestsArrival": "15:30",
    "registrationStart": "15:00",
    "banquetStart": "18:00"
  },
  "placesMode": 2,
  "places": {
    "registration": {
      "name": "Агроэкоусадьба Три колодца",
      "address": "Брестская область, Каменецкий район, деревня Баранки, дом 3"
    },
    // "banquet": {
    //   "name": "Ресторан Летний дворец",
    //   "address": "Санкт-Петербургское шоссе 130 к7"
    // }
  },
  "timeline": [
    {
      ...
      "time": "14:45",
      "icon": "glasses",
      "descr": "Не забудьте взять хорошее настроение и улыбки"
    },
    {
      "title": "Церемония:",
      "time": "15.00",
      "icon": "rings",
      "descr": "Не исключено, что вам потребуются платочки для этого трогательного момента"
    },
    {
      "title": "Свадебный ужин",
      "time": "17.00",
      "icon": "plate",
      "descr": "Вкусные блюда и весёлая программа от нашего крутого ведущего"
    },
    {
      "title": "Свадебный торт",
      "time": "21.00",
      "icon": "plate",
      "descr": "Обещаем, торт продавать мы не будем"
    },
    {
      "title": "Окончание вечера",
      "time": "23.00",
      "icon": "glasses",
      "descr": "Даже такая вечеринка может закончиться, но мы придумаем ещё поводы собраться вместе"
    }
  ],
  "questions": [
    {
      "type": "radio",
      "label": "Понадобится ли вам трансфер:",
      "options": [
        {"value": "Нужен", "text": "Да"},
        {"value": "Не нужен", "text": "Нет"}
      ]
    },
    {
      "type": "checkbox",
      ...
      "options": [
        ...
        {"value": "Рыба", "text": "Рыбка"},
        {"value": "Мясо", "text": "Мяско"}
      ]
    },
    {
      "type": "text",
      "label": "Пожелания по алкоголю:"
    }
  ],
  "checkboxes": {
    "showDresscodeColors": true,
    "separateDresscode": true,
    "showPinterestLink": true,
    "showDresscodeColorsMen": true,
    "menShowPinterestLink": false,
    "showDresscodeColorsWomen": true,
    "womenShowPinterestLink": false,
    "showDetails": true,
    "showRsvp": true,
    "showTimeline": true,
    "showQuestions": true,
